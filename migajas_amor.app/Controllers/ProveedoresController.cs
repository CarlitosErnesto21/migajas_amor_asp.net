...
namespace migajas_amor.app.Controllers
{
    public class ProveedoresController : Controller
    {
        ...
        public ProveedoresController(MigajasAmorContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Telefono,Email,Direccion")] Proveedore proveedore)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Telefono,Email,Direccion")] Proveedore proveedore)
        {
            if (id != proveedore.Id)
            {
                return NotFound();
